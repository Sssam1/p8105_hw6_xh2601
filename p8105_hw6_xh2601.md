...
zero on most days in the original dataset, so many bootstrap samples
contain little or no variation in prcp. In such samples, the estimated
coefficient beta2 for prcp approaches zero, causing the ratio of beta1 /
beta2 to explode to extremely large absolute values.
...
around a central peak, while the tails remain wide. This reflects
instability in the denominator beta2, and the ratio is not a meaningful
or interpretable relationship between the predictors tmax and prcp in
this sample.
...
```
    ...
    ##         <dbl>       <dbl>               <dbl>               <dbl>
    ## 1       0.894       0.928              -5201.               4005.

The 95% confidence interval for R-squared is 0.8937176 to 0.9275479, the
The 95% confidence interval for beta ratio is -5201.1612096 to
4005.0820406.
...
<img src="p8105_hw6_xh2601_files/figure-gfm/unnamed-chunk-16-1.png" width="90%" />
...
<img src="p8105_hw6_xh2601_files/figure-gfm/unnamed-chunk-20-1.png" width="90%" />
