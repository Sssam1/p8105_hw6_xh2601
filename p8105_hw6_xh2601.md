...
```
    ...
    ## -722645.3    -846.4    -499.9    -115.5    -318.5 2917751.4
...
```
    ...
    ## # A tibble: 1 × 6
    ##   r2_mean r2_ci_lower r2_ci_upper beta_ratio_mean beta_ratio_ci_lower
    ##     <dbl>       <dbl>       <dbl>           <dbl>               <dbl>
    ## 1   0.913       0.894       0.928           -116.              -5220.
    ## # ℹ 1 more variable: beta_ratio_ci_upper <dbl>

The 95% confidence interval for R-squared is 0.8938882 to 0.9276035, the
The 95% confidence interval for beta ratio is -5219.7853823 to
4209.0410464.
