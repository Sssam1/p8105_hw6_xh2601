...
To visualize the central behavior of the ratio, the following histogram looks at only the middle 98% of the bootstrap distribution (the 1%–99% interval). Within this trimmed range, the majority of values cluster around a central peak, while the tails remain wide. This reflects instability in the denominator beta2, and the ratio is not a meaningful or interpretable relationship between the predictors tmin and prcp in this sample.
